...
class D435:
    ...
    def __init__(self, fps=30, color_width=640, color_height=480, depth_width=640, depth_height=480):
    ...
    def get_color_intrinsics(self):
        color_intr_ = self.profile.get_stream(rs.stream.color).as_video_stream_profile().get_intrinsics()
        color_intr = {
